...
class WordModel {
    ...
    var randomCorrectResponse : String {
        let correctResponses : [String] = ["Awesome!", "Nice job!", "You got it!"]
        return correctResponses.randomElement()!
    }
    
    var randomIncorrectResponse : String {
        let incorrectResponses : [String] = ["Try Again!", "Oops!", "Wrong :("]
        return incorrectResponses.randomElement()!
    }
